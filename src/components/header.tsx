...
function Header() {
  ...
  const navList = 
    <>
      <NavLink to="https://app.habitbeacon.com/" target="_blank" text="Log In" setNavOpen={setNavOpen} />
  ...
  return (
    ...
    <header className="NavBar flex justify-between fixed w-full">
      ...
      <div className="flex flex-row">
        <a href="https://app.habitbeacon.com/" target="_blank" className="Link1 rounded-md whitespace-nowrap text-md my-auto mr-[1vw] py-1.5 px-[3vw] h-fit bg-gradient-to-tr from-green-500 to-blue-700 hover:from-green-600 hover:to-blue-800">
          Sign&nbsp;Up&nbsp;Now!
        </a>
